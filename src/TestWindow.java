...
public class TestWindow extends JPanel
{
	 ...
	 */
	public TestWindow(Image image, int style)
	{
	 ...
	 */
	public TestWindow(Image image, int style, float alignmentX, float alignmentY)
	{
		setImage( image );
		setStyle( style );
	 ...
	 */
	public TestWindow(Paint painter)
	{
		setPaint( painter );
		setLayout( new BorderLayout() );
	}
